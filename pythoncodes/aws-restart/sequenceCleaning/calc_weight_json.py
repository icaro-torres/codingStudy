"""
# there IS some error happening in this code, so i will fix it now

import jsonFileHandler
data = jsonFileHandler.readJsonFile('sequenceCleaning/insulin.json')
...
# now i will write a function code
...
if data != "":
    bInsulin = data['molecules']['bInsulin']
    aInsulin = data['molecules']['aInsulin']
    # correction: i made a typing mistake here, not concatenating the strings
